...
if (isset($_POST["submit"])) {
    ...
    $sql = "INSERT INTO `order`(`id`, `name`, `Client_Id`, `shippingAgent_Id`, `Menu_Id`, `is_dilevered`) 
   VALUES (NULL,'$name','$Client_Id','$shippingAgent_Id','$Menu_Id','$is_dilevered')";
    //   INSERT INTO `menu`(`id`, `name`, `description`, `price`, `profile`, `reviews`) VALUES ('[value-1]','[value-2]','[value-3]','[value-4]','[value-5]','[value-6]')
    $result = mysqli_query($conn, $sql);

    if ($result) {
        header("Location: ../order.php?msg=New order created successfully");
    } else {
...
<head>
    ...
    <title>Dash RESTIAM - ADD new Orders</title>
</head>
        ...
        <div class="container d-flex justify-content-center">
            <form action="" method="post" enctype="multipart/form-data" style="width:50vw; min-width:300px;">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control" name="Client_Id" placeholder="1" required>
                </div>
                 
                <div class="mb-3">
                    <label class="form-label">shippingAgent Id:</label>
                    <input type="number" class="form-control" name="shippingAgent_Id" placeholder="1" required>
                </div>
                 
                <div class="mb-3">
                    <label class="form-label">Menu Id:</label>
                    <input type="number" class="form-control" name="Menu_Id" placeholder="1" required>
                </div>
                <br>
               ...
               &nbsp;
               <input type="radio" class="form-check-input" name="is_dilevered" id="true" value="true">
               <label for="true" class="form-input-label">true</label>
               &nbsp;
               <input type="radio" class="form-check-input" name="is_dilevered" id="false" value="false">
